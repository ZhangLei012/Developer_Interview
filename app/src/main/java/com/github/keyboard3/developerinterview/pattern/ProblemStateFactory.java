...
public class ProblemStateFactory {
    ...
    static Class<?> [] problemsClass = { MachineLearningState.class
                                        , DeepLearningState.class
                                        , ReinforcementLearningState.class
                                        , RecommendationAlgorithmState.class
                                        , ComputerVisionState.class
                                        , NLPState.class
                                        , MatrixTheoryState.class
                                        , JavaState.class};
